...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.statement = function () {
        try {
            ...
            while (this.check(_lexer__WEBPACK_IMPORTED_MODULE_0__.TokenType.Greet)) {
                // Peek ahead to see if this greeting is followed by a statement that requires it
                var nextToken = this.tokens[this.current + 1];
                if (nextToken && (nextToken.type === _lexer__WEBPACK_IMPORTED_MODULE_0__.TokenType.Var ||
                    nextToken.type === _lexer__WEBPACK_IMPORTED_MODULE_0__.TokenType.If ||
                    nextToken.type === _lexer__WEBPACK_IMPORTED_MODULE_0__.TokenType.Print ||
                    nextToken.type === _lexer__WEBPACK_IMPORTED_MODULE_0__.TokenType.Identifier // Could be assignment
                )) {
